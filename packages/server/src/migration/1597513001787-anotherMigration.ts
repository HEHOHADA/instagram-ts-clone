...
export class anotherMigration1597513001787 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "likes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "photoId" uuid NOT NULL, "userId" uuid NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), CONSTRAINT "PK_a9323de3f8bced7539a794b4a37" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "photo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), "pictureUrl" character varying NOT NULL, "postText" character varying, "userId" uuid NOT NULL, CONSTRAINT "PK_723fa50bf70dcfd06fb5a44d4ff" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "comment" ("photoId" uuid NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "commentText" text NOT NULL, "userId" uuid NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
