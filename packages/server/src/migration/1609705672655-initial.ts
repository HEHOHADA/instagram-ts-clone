...
export class initial1609705672655 implements MigrationInterface {
  name = 'initial1609705672655'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "comment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "photoId" uuid NOT NULL, "commentText" text NOT NULL, "userId" uuid NOT NULL, "date" TIMESTAMP NOT NULL, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "likes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "photoId" uuid NOT NULL, "userId" uuid NOT NULL, "date" TIMESTAMP NOT NULL, CONSTRAINT "PK_a9323de3f8bced7539a794b4a37" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "photo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL, "pictureUrl" character varying NOT NULL, "postText" character varying, "userId" uuid NOT NULL, CONSTRAINT "PK_723fa50bf70dcfd06fb5a44d4ff" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
