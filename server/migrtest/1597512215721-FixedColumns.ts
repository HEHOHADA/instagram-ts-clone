...
export class FixedColumns1597512215721 implements MigrationInterface {
    name = 'FixedColumns1597512215721'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "likes" DROP COLUMN "likerId"`);
        ...
        await queryRunner.query(`ALTER TABLE "likes" DROP CONSTRAINT "PK_e24989f445c2652f8ebc326667f"`);
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "PK_7887c268ff8a69367dae2a41161" PRIMARY KEY ("photoId", "id")`);
        ...
        await queryRunner.query(`ALTER TABLE "likes" DROP CONSTRAINT "PK_7887c268ff8a69367dae2a41161"`);
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "PK_a9323de3f8bced7539a794b4a37" PRIMARY KEY ("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "likes" DROP CONSTRAINT "PK_7887c268ff8a69367dae2a41161"`);
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "PK_e24989f445c2652f8ebc326667f" PRIMARY KEY ("photoId")`);
        ...
        await queryRunner.query(`ALTER TABLE "likes" ADD "likerId" uuid NOT NULL`);
