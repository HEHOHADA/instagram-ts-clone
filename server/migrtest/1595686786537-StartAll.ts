...
export class StartAll1595686786537 implements MigrationInterface {
    name = 'StartAll1595686786537'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "likes" ("photoId" uuid NOT NULL, "likerId" uuid NOT NULL, "date" date NOT NULL DEFAULT '"2020-07-25T14:19:49.828Z"', "photoPhotoId" uuid, "userId" uuid, CONSTRAINT "PK_e24989f445c2652f8ebc326667f" PRIMARY KEY ("photoId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "follower" ("userId" uuid NOT NULL, "followerId" uuid NOT NULL, "date" date NOT NULL DEFAULT '"2020-07-25T14:19:49.845Z"', CONSTRAINT "PK_6fe328c3c08b70a5c9c79348839" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE TABLE "following" ("userId" uuid NOT NULL, "followingId" uuid NOT NULL, "date" date NOT NULL DEFAULT '"2020-07-25T14:19:49.858Z"', CONSTRAINT "PK_fc4cbf2396bf4bb1df9ecb3cc4a" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("photoId" uuid NOT NULL, "comment" text NOT NULL, "userId" uuid NOT NULL, "date" date NOT NULL DEFAULT '"2020-07-25T14:19:49.859Z"', "photoPhotoId" uuid, CONSTRAINT "PK_16688e4a4f41cb008e4d7934a4c" PRIMARY KEY ("photoId"))`);
